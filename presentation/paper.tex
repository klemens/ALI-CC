...
\makebox[\textwidth][c] {
\includegraphics[width=0.39\textwidth, keepaspectratio=true]{plots/plot_links.pdf}%
\includegraphics[width=0.39\textwidth, keepaspectratio=true]{plots/plot_links_internal.pdf}%
\includegraphics[width=0.39\textwidth, keepaspectratio=true]{plots/plot_links_external.pdf}
}
\centerline{Seiten mit den meisten (links), meisten internen (mitte) und meisten externen (rechts) Links}
\vspace{0cm}
